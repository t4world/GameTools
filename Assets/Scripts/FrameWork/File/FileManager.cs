...
public class FileManager
{
        ...
        while (true)
        {
            ...
            catch (Exception exception)
            {
                ...
                if (num >= 3)
                {
                    ...
                    s_delegateOnOperateFileFail(directory, FileOperationType.CreateDirectory);
                    return false;
                }
            }
        }
        ...
        while (true)
        {
            ...
            catch (Exception exception)
            {
                ...
                if (num >= 3)
                {
                    ...
                    s_delegateOnOperateFileFail(directory, FileOperationType.DeleteDirectory);
                    return false;
                }
            }
        }
        ...
        while (true)
        {
            ...
            catch (Exception exception)
            {
                ...
                if (num >= 3)
                {
                    ...
                    s_delegateOnOperateFileFail(filePath, FileOperationType.DeleteFile);
                    return false;
                }
            }
        }
    ...
    public static byte[] ReadFile(string filePath)
    {
        if (IsFileExist(filePath))
        {
            ...
            s_delegateOnOperateFileFail(filePath, FileOperationType.ReadFile);
        }
        return null;
    }
        ...
        while (true)
        {
            ...
            catch (Exception exception)
            {
                ...
                if (num >= 3)
                {
                    ...
                    DeleteFile(filePath);
                    s_delegateOnOperateFileFail(filePath, FileOperationType.WriteFile);
                    return false;
                }
            }
        }
    ...
    public delegate void DelegateOnOperateFileFail(string fullPath, FileOperationType fileOperation);
}
